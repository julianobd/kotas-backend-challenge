...
public interface IPokemonService
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the Pokémon data transfer object
    ...
    ///     <see cref="PokemonDto" /> representing all Pokémon.
    /// </returns>
